...
set_clock_latency -source -rise -early 150 [get_clocks dco_clk]
set_clock_latency -source -fall -early 151 [get_clocks dco_clk]
set_clock_latency -source -rise -late 152 [get_clocks dco_clk]
set_clock_latency -source -fall -late 153 [get_clocks dco_clk]
...
set_clock_latency -source -rise -early 151 [get_clocks lfxt_clk]
set_clock_latency -source -fall -early 152 [get_clocks lfxt_clk]
set_clock_latency -source -rise -late 153 [get_clocks lfxt_clk]
set_clock_latency -source -fall -late 154 [get_clocks lfxt_clk]
